            ...
            <div class="shadow special-text mt-3 d-block d-md-inline-block col-lg-3 col-12 px-0 p-4 "
                ...
                <ul style="text-align: justify;line-height: 3rem" class="pr-3">
                    ...
                    <li>
                        <span>میز کودک : </span>
                        <span>
                            @if(isset($res->options->child_bench))
                                دارد
                            @else
                                ندارد
                            @endif
